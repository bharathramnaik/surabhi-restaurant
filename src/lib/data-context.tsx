...
export type Order = { id: string; orderNumber: number; tableId: string | null; tableNumber: number | null; customerName: string; customerPhone: string; items: OrderItem[]; status: "pending" | "in_progress" | "served" | "billed"; notes: string; subtotal: number; tax: number; discount: number; total: number; createdAt: string };
